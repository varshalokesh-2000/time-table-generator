...
<head>
    ...
    <title>BIET TIMETABLE SYSTEM</title>
...
<div class="navbar navbar-inverse navbar-fixed-top " id="menu">
    <div class="container">
        <div align="center">
            <h3 align="center">BAPUJI INSTITUTE OF ENGINEERING AND TECHNOLOGY,INFORMATION SCIENCE DEPARTMENT</h3>
        </div>
    </div>
</div>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        ...
        <div class="item">
            <img src="assets/img/2.jpeg" alt="Chania">
        </div>

        <div class="item">
            <img src="assets/img/dep.jpeg" alt="Flower">
        </div>

        <div class="item">
            <img src="assets/img/3.jpeg" alt="Flower">
        </div>
    </div>
</div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.4s">
                <div class="faculty-div">
                    <img src="assets/img/faculty/deansir.jpeg" class="img-rounded"/>
                    <h3 align="center">Dr. K. Sadashivappa</h3>
                    <hr/>
                    <h4 align="center">Dean<br/>Academic,BIET</h4>
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.5s">
                <div class="faculty-div">
                    ...
                    <h3 align="center">Dr. H B Aravind</h3>
                    <hr/>
                    <h4 align="center">Principal<br/> BIET</h4>

                </div>
            </div>
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.6s">
                <div class="faculty-div">
                    <img src="assets/img/faculty/hodmam.jpeg" class="img-rounded"/>
                    <h3 align="center">Dr.Poornima B</h3>
                    <hr/>
                    <h4 align="center">HOD<br/>Information Science Department</h4>
...
<div class="container">
    <div class="row set-row-pad">
        <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1 "
            ...
            <hr/>
            <div>
                <h4> #325, Shamanur Rd,BIET, 
                </h4>
                <h4>  Davanagere, Karnataka 577004</h4>
                <h4><strong>Call:</strong> 081922 21461 </h4>
                <h4><strong>Email: </strong>webmaster@bietdvg.edu</h4>
            </div>
        ...
        <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1"
            ...
            <hr/>
            <div>
                <a href="https://www.facebook.com/BapujiInstituteOfEngineeringTechnology"> <img src="assets/img/Social/facebook.png" alt=""/> </a>
